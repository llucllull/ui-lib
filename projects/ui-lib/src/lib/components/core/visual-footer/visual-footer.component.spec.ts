...
describe('VisualFooterComponent', () => {
  ...
  it('debería renderizar el contactTitle si existe', () => {
    ...
    const el = fixture.debugElement.query(By.css('.visual-footer__contact .title')).nativeElement;
    expect(el.textContent).toContain('Contacto');
  });

  it('debería renderizar el contactPhone si existe', () => {
    component.contactPhone = { label: 'Llámanos', url: 'tel:+34123456789', linkType: LinkType.External } as any;
    fixture.detectChanges();
  ...
  it('debería renderizar el contactEmail si existe', () => {
    component.contactEmail = { label: 'Escríbenos', url: 'mailto:test@mail.com', linkType: LinkType.External } as any;
    fixture.detectChanges();

    const el = fixture.debugElement.queryAll(By.css('.visual-footer__contact a'))[0].nativeElement;
  ...
  it('debería renderizar el addressTitle si existe', () => {
    ...
    const el = fixture.debugElement.query(By.css('.visual-footer__address .title')).nativeElement;
  ...
  it('debería renderizar la dirección si existe', () => {
    ...
    const text = fixture.debugElement.query(By.css('.visual-footer__address .text')).nativeElement.textContent;
  ...
  it('debería renderizar el socialsTitle y los socials si existen', () => {
    ...
    const title = fixture.debugElement.query(By.css('.visual-footer__socials .title')).nativeElement;
